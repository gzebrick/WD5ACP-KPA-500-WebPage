...
// Version 2.19 Modified some screen elements to show dark grey when power is off
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (AmpConnect.indexOf("NOT") > 0) {
              client.print("<p> <span style=color:black;background-color:grey;padding:8px;border:double;font-size:24px>" );  
            }
            else {
              client.print("<p> <span style=color:black;background-color:#FFAA00;padding:8px;border:double;font-size:24px>" );  //LCD orange was #FFAA00
            }
            ...
            client.print("<p><span style=font-family:'Times New Roman', serif> WebServer refresh: 5 seconds. Connected to:  ");
            client.print(ssid);
