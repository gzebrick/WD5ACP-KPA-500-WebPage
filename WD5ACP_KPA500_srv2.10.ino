      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>WD5ACP Elecraft KPA500 <> WebServer Ver 2.10</h1>");  // Here's the version number ........................................
            ...
            client.print(PaAmps);
            client.print(" A   ");
            client.print(" = PA Watts // Peak PA Watts: "); 
            client.print(InputWatts);
            client.print(" W  // ");
            client.print(PeakInputWatts);
            client.print(" W </p>");
            client.println("<p> Effeciency (best measured with steady tune) = Peak Watts/Peak PA Watts: ");
