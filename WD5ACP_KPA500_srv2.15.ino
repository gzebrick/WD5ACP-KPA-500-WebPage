        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (OpMode.startsWith("OPER")) {
              client.print("<span style=background-color:lime;padding:6px;font-size:28px;border:solid>");
              client.print("OPERATE");
              client.print("</span>");
              client.print("<span style=background-color:white;color:white;padding:6px;font-size:28px>");
              client.print("-----");
              client.print("</span>");
              client.print("<span style=background-color:grey;padding:6px;font-size:28px;border:solid>"); 
              ...
              client.print("-----");
              client.print("</span>");
              client.print("<span style=background-color:yellow;padding:6px;font-size:28px;border:solid>"); // 
              client.print("STANDBY");
              client.print("</span>");
            }
            ...
            client.print("<p> <span style=color:black;background-color:#FF9900;padding:6px;border:double;font-size:24px>" );  //LCD orange was #FF9900
