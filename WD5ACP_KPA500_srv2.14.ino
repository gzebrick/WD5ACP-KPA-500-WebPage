        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (OpMode.startsWith("OPER")) {
              client.print("<span style=background-color:lime;font-size:24px;border:solid>");
              client.print("OPER");
              client.print("</span>");
              client.print("<span style=background-color:white;color:white;font-size:24px>");
              client.print(" ---- ");
              client.print("</span>");
              client.print("<span style=background-color:grey;font-size:24px;border:solid>"); // color was #FFB0900
              client.print("STBY");
              client.print("</span>");
            }
            else {
              client.print("<span style=background-color:grey;font-size:24px;border:solid>");
              client.print("OPER");
              client.print("</span>");
              client.print("<span style=background-color:white;color:white;font-size:24px>");
              client.print(" ---- ");
              client.print("</span>");
              client.print("<span style=background-color:yellow;font-size:24px;border:solid>"); // color was #FFB0900
              client.print("STBY");
              client.print("</span>");
            }
            ...
            client.print("<p> <span style=color:black;background-color:#FFDA00;border:double;font-size:24px> " );  //LCD orange was #FFB000
            ...
            client.print("<a href=\"/PeakClear/ClearPeak\"><button class=\"button.button2\">CLEAR PEAK HOLDS</button></a> </p>" );
            client.println("</body></html>");
            client.println("<p> Screen updates every 5 seconds </p>");
