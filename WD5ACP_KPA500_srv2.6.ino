      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>WD5ACP Elecraft KPA500 <> WebServer Ver 2.6</h1>");
            ...
            if (OnMode.indexOf("ON") > 0) {
              client.print("<span style=color:black;background-color:#FF9900;font-size:24px> " );  //LCD orange
            }
            else {
              client.print("<span style=color:black;background-color:grey;font-size:24px> " );
            }
            ...
            if (OpMode.startsWith("OPERATE")) {
              ...
              client.print("<span style=background-color:#FF9900;font-size:24px>");
            }
            ...
            if (PeakWatts > 499) {
              client.print("<span style=background-color:lightyellow;> " );
            }
            if (PeakWatts > 599) {
